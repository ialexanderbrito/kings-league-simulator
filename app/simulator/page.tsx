...
export const metadata: Metadata = {
  title: 'Simulador Kings League Brasil 2026 | Simule Partidas e Preveja o Campeão',
  description: '⚽ SIMULE partidas da Kings League Brasil 2026 em tempo real! Altere placares, veja como fica a classificação, simule os playoffs e descubra quem será o CAMPEÃO! O simulador mais completo e interativo do Brasil com dados oficiais atualizados automaticamente.',
  keywords: [
  ...
  openGraph: {
    title: 'Simulador Kings League 2026 ⚽ | Simule e Preveja o Campeão',
  ...
  twitter: {
    ...
    title: 'Simulador Kings League 2026 ⚽',
